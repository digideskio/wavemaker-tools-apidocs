 ...
 * @since 12/11/14
 */
public abstract class AnnotationApiParserRunner extends ApiParserRunner {

    public AnnotationApiParserRunner(final ApiParserConfiguration parserConfiguration) {
