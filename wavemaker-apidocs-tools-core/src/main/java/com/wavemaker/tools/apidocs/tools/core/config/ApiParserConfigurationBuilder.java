 ...
 */
package com.wavemaker.tools.apidocs.tools.core.config;

import java.util.HashSet;
import java.util.LinkedHashSet;
import java.util.Set;

import com.wavemaker.tools.apidocs.tools.core.context.ParameterResolversContext;
import com.wavemaker.tools.apidocs.tools.core.filter.ModelFilter;
import com.wavemaker.tools.apidocs.tools.core.filter.ModelPackageFilter;
import com.wavemaker.tools.apidocs.tools.core.filter.ObjectTypeFilter;
import com.wavemaker.tools.apidocs.tools.core.filter.PrimitiveTypeFilter;
import com.wavemaker.tools.apidocs.tools.core.resolver.ParameterResolver;
import com.wavemaker.tools.apidocs.tools.core.scanner.ClassScanner;
...
public class ApiParserConfigurationBuilder {
    ...
    private final ParameterResolversContext resolversContext = new ParameterResolversContext();
