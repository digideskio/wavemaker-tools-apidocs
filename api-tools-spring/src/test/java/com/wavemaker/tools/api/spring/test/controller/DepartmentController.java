...
import com.wavemaker.tools.api.spring.test.Department;
import com.wavemaker.tools.api.spring.test.service.DepartmentService;
...
public class DepartmentController {
    ...
    public Department editDepartment(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
        Department department = WMMultipartUtils.toObject(multipartHttpServletRequest,Department.class);
